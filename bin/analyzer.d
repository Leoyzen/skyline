...
start () {
    ...
    /home/tops/bin/python2.7 $BASEDIR/src/analyzer/analyzer-agent.py start
        RETVAL=$?
        if [[ $RETVAL -eq 0 ]]; then
...
stop () {
    ...
    /home/tops/bin/python2.7 $BASEDIR/src/analyzer/analyzer-agent.py stop
        RETVAL=$?
        if [[ $RETVAL -eq 0 ]]; then
...
run () {
    ...
    /home/tops/bin/python2.7 $BASEDIR/src/analyzer/analyzer-agent.py run
}
